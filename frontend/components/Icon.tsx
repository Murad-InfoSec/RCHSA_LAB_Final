...
export const RedHatIcon: React.FC<IconProps> = ({ className }) => (
  <svg viewBox="0 0 1024 1024" className={className} xmlns="http://www.w3.org/2000/svg">
    {/* Main Red Fedora Body */}
    <path 
      fill="#FF0000" 
      d="M512.4 20.4c-68.5 0-141.2 43.1-238.2 43.1-21.6 0-32.9 5.3-39.7 15.9-6.8 10.6-8.8 26.1-5.9 44.5 13.5 83.1 53.3 192.5 53.3 268.4 0 6.6 0.1 13.1 0.4 19.5-121.5 6.3-270.3 84.7-270.3 266.3 0 166.7 225.4 325 512.4 325s512.4-158.3 512.4-325c0-181.6-148.8-260-270.3-266.3 0.3-6.4 0.4-12.9 0.4-19.5 0-75.9 39.8-185.3 53.3-268.4 2.9-18.4 0.9-33.9-5.9-44.5-6.8-10.6-18.1-15.9-39.7-15.9-97 0-169.7-43.1-238.2-43.1z"
    />
    {/* Black Hat Band */}
    <path 
      fill="#000000" 
      d="M271.8 320.1c-13.8 61.2-24.3 135.6-24.3 205.9 0 6.4 0.1 12.8 0.3 19.1 84.2 78.5 169.7 116.3 264.6 116.3s180.4-37.8 264.6-116.3c0.2-6.3 0.3-12.7 0.3-19.1 0-70.3-10.5-144.7-24.3-205.9-106.8 91.5-240.3 134.7-481.2 100z"
...
export const SettingsIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 2 2 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"></path></svg>
);
